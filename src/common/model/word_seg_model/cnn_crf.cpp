...
std::vector<ResultTag> CNNCRF::forward(std::vector<std::string> &input) {
    ...
    MatrixXf conv1d_layer_1_out = EigenOp::multi_kernel_conv1d(
        ...
        "relu");
    MatrixXf conv1d_layer_2_out = EigenOp::multi_kernel_conv1d(
        conv1d_layer_1_out, m_conv_layer_2_3, m_conv_layer_2_5,
        m_conv_layer_2_7, "relu");
    MatrixXf conv1d_layer_3_out = EigenOp::multi_kernel_conv1d(
...
bool CNNCRF::load(std::string &cnn_config) {
    ...
    std::string convs_layer_1_1_path, convs_layer_1_3_path,
        convs_layer_1_5_path;
    std::string convs_layer_2_3_path, convs_layer_2_5_path,
        convs_layer_2_7_path;
    std::string convs_layer_3_1_path, convs_layer_3_3_path,
    ...
    for (auto iter = node_list.begin(); iter != node_list.end(); ++iter) {
        ...
        if (convs_layer_1_1_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_11_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_1_3_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_13_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_1_5_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_15_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_2_3_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_23_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_2_5_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_25_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_2_7_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_27_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_3_1_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_31_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_3_3_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_33_path_prefix empty";
            return false;
        }
        ...
        if (convs_layer_3_5_path.empty()) {
            LOG_INFO
                << "word seg cnn_crf model conv_layer_35_path_prefix empty";
            return false;
        }
    ...
    // embedding
    m_embedding = EigenOp::loadEmbeddingParam(word_embedding_path, m_vocab_size,
                                              m_emb_dim);
    ...
    m_crf_transistion_layer =
        EigenOp::crfTransistionParam(crf_path, m_tag_size);
    return true;
}