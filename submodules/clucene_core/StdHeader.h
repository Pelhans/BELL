...
/**
 * This header contains public distributed code that needs to be included
 * *before* any clucene-core code is included. It also uses the clucene-shared
 * header which contains platform specific code configured by cmake.
 */
...
#define StringArrayWithDeletor \
    CL_NS(util)::CLVector<TCHAR*, CL_NS(util)::Deletor::tcArray>
#define StringArray std::vector<TCHAR*>
#define StringArrayWithDeletor \
    CL_NS(util)::CLVector<TCHAR*, CL_NS(util)::Deletor::tcArray>
#define StringArrayConst std::vector<const TCHAR*>
//#define StringArrayConstWithDeletor  CL_NS(util)::CLVector<const TCHAR*,
// CL_NS(util)::Deletor::tcArray >

#define AStringArray std::vector<char*>
#define AStringArrayWithDeletor \
    CL_NS(util)::CLVector<char*, CL_NS(util)::Deletor::acArray>
#define AStringArrayConst std::vector<const char*>
//#define AStringArrayConstWithDeletor CL_NS(util)::CLVector<const char*,
