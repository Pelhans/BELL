...
/**
 * Filters {@link lucene::analysis::standard::StandardTokenizer} with {@link
 * lucene::analysis::standard::StandardFilter},
 * {@link lucene::analysis::LowerCaseFilter} and {@link
 * lucene::analysis::StopFilter}, using a list of English stop words.
 *
 */
...
public:
     ...
     */
    StandardAnalyzer(CL_NS(util)::Reader* stopwordsReader,
     ...
     */
    void setMaxTokenLength(const int32_t length) { maxTokenLength = length; }

    /**
     * @see #setMaxTokenLength
     */
    int getMaxTokenLength() const { return maxTokenLength; }
};
CL_NS_END2
#endif
