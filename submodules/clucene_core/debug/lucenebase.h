...
public:
    ...
    LuceneBase() { _LUCENE_ATOMIC_INT_SET(__cl_refcount, 1); }
    inline int __cl_getref() { return _LUCENE_ATOMIC_INT_GET(__cl_refcount); }
...
#define LUCENE_BASE \
public              \
    CL_NS(debug)::LuceneBase
#else
#define LUCENE_BASE \
public              \
    CL_NS(debug)::LuceneVoidBase
#endif
#define LUCENE_REFBASE \
public                 \
    CL_NS(debug)::LuceneBase // this is the base of classes who *always* need
                             // refcounting
