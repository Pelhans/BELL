...
public:
    ...
    static void timeToString(const int64_t time, Resolution resolution,
    ...
    *****/
     ...
     */
    static int64_t getTime(unsigned short year, uint8_t month, uint8_t mday,
                           uint8_t hours = 0, uint8_t minutes = 0,
                           uint8_t seconds = 0, unsigned short ms = 0);
    ...
    static TCHAR* getISOFormat(unsigned short year, uint8_t month, uint8_t mday,
                               uint8_t hours = 0, uint8_t minutes = 0,
                               uint8_t seconds = 0, unsigned short ms = 0);
