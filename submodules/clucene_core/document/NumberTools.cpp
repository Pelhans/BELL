...
const TCHAR* NumberTools::MIN_STRING_VALUE =
    NEGATIVE_PREFIX _T("0000000000000");
const TCHAR* NumberTools::MAX_STRING_VALUE =
    POSITIVE_PREFIX _T("1y2p0ij32e8e7");
...
TCHAR* NumberTools::longToString(int64_t l) {
    ...
    for (size_t i = 1; i < STR_SIZE - len; i++) buf[i] = (int)'0';
