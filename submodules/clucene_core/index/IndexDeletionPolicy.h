...
public:
     ...
     * IndexDeletionPolicy} in effect and therefore this should only be called
     * by its {@link IndexDeletionPolicy#onInit onInit()} or
...
/**
 * <p>Expert: policy for deletion of stale {@link IndexCommitPoint index
 * commits}.
 *
...
class CLUCENE_EXPORT KeepOnlyLastCommitDeletionPolicy
    : public IndexDeletionPolicy {
public:
