...
public:
    ...
    public:
        ...
        /**
         * Constructor
         * @memory, segments object is consumed. The SegmentInfo objects within
         * are referenced
         */
     ...
     */
    virtual MergeSpecification* findMergesForOptimize(
     ...
     */
    virtual bool useCompoundFile(SegmentInfos* segments,
...
class CLUCENE_EXPORT LogMergePolicy : public MergePolicy {
    ...
    bool isOptimized(SegmentInfos* infos, IndexWriter* writer,
...
public:
    ...
    MergeSpecification* findMergesForOptimize(
        SegmentInfos* segmentInfos, IndexWriter* writer,
        int32_t maxSegmentCount, std::vector<SegmentInfo*>& segmentsToOptimize);
