...
SegmentTermVector::SegmentTermVector(const TCHAR* _field,
                                     ArrayBase<TCHAR*>* _terms,
                                     ArrayBase<int32_t>* _termFreqs) {
    this->field = STRDUP_TtoT(
        _field); // TODO: Try and avoid this dup (using intern'ing perhaps?)
    this->terms = _terms;
...
TermPositionVector* SegmentTermVector::__asTermPositionVector() { return NULL; }

const TCHAR* SegmentTermVector::getField() { return field; }
...
int32_t SegmentTermVector::binarySearch(const ArrayBase<TCHAR*>& a,
...
ArrayBase<int32_t>* SegmentTermVector::indexesOf(
...
SegmentTermPositionVector::SegmentTermPositionVector(
    const TCHAR* field, ArrayBase<TCHAR*>* terms, ArrayBase<int32_t>* termFreqs,
...
ArrayBase<int32_t>* SegmentTermPositionVector::indexesOf(
    const ArrayBase<TCHAR*>& termNumbers, const int32_t start,
    const int32_t len) {
...
const ArrayBase<TermVectorOffsetInfo*>* SegmentTermPositionVector::getOffsets(
    const size_t index) {
...
const ArrayBase<int32_t>* SegmentTermPositionVector::getTermPositions(
    const size_t index) {
