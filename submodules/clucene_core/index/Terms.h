...
public:
    ...
    // as int64_t as the <i>docs</i> array.
    //
...
public:
     ...
     * @param pointer if true, then increment the reference count before
     * returning
     */
 ...
 * ordinal positions of each occurrence of a term in a document.
 *
