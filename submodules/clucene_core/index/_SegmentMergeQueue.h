...
class SegmentMergeQueue
    : public CL_NS(util)::PriorityQueue<
          SegmentMergeInfo*, CL_NS(util)::Deletor::Object<SegmentMergeInfo>> {
public:
    // Constructor
...
protected:
    // Overloaded method that implements the lessThan operator for the parent
    // class This method is used by the parent class Priority queue to reorder
    // its internal data structures. This implementation check if stiA is less
    // than the current term of stiB.
