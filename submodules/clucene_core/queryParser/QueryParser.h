...
private:
    ...
    typedef CL_NS(util)::CLHashMap<
        const TCHAR*, CL_NS(document)::DateTools::Resolution,
        CL_NS(util)::Compare::TChar, CL_NS(util)::Equals::TChar,
        CL_NS(util)::Deletor::Dummy,
        CL_NS(util)::Deletor::DummyInt32> FieldToDateResolutionType;
...
public:
    ...
    static CL_NS(search)::Query* parse(const TCHAR* q, const TCHAR* f,
    ...
    */
     ...
     * resolutions can be set with {@link #setDateResolution(String,
     ...
     * field. Returns null (NO_RESOLUTION), if no default or field specific date
     * resolution has been set for the given field.
     *
     */
    CL_NS(document)::DateTools::Resolution
        getDateResolution(const TCHAR* fieldName) const;

protected:
    void addClause(std::vector<CL_NS(search)::BooleanClause*>& clauses,
                   int32_t conj, int32_t mods, CL_NS(search)::Query* q);

    /**
     * @exception ParseException throw in overridden method to disallow
     */
    virtual CL_NS(search)::Query* getFieldQuery(const TCHAR* _field,
                                                TCHAR* queryText);
     ...
     * @exception ParseException throw in overridden method to disallow
     */
    virtual CL_NS(search)::Query* getRangeQuery(const TCHAR* field,
     ...
     * @exception ParseException throw in overridden method to disallow
     */
    CL_NS(search)::Query* getBooleanQuery(
        std::vector<CL_NS(search)::BooleanClause*>& clauses,
        bool disableCoord = false);
     ...
     * @exception ParseException throw in overridden method to disallow
     */
    virtual CL_NS(search)::Query* getWildcardQuery(const TCHAR* _field,
                                                   TCHAR* termStr);
     ...
     * @exception ParseException throw in overridden method to disallow
     */
    virtual CL_NS(search)::Query* getPrefixQuery(const TCHAR* _field,
                                                 TCHAR* _termStr);
     ...
     * @exception ParseException throw in overridden method to disallow
     */
    virtual CL_NS(search)::Query* getFuzzyQuery(const TCHAR* _field,
                                                TCHAR* termStr,
...
private:
    ...
    CL_NS(util)::CLVector<CL_NS(util)::ValueArray<int32_t>*,
                          CL_NS(util)::Deletor::Object<
                              CL_NS(util)::ValueArray<int32_t>>>* jj_expentries;
...
private:
    ...
    TCHAR* getParseExceptionMessage(
