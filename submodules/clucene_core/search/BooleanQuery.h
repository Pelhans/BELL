...
public:
    typedef CL_NS(util)::CLVector<
        BooleanClause*,
        CL_NS(util)::Deletor::Object<BooleanClause>> ClausesType;
...
public:
     ...
     *  <li>For add(query, false, false) use add(query,
     * BooleanClause.Occur.SHOULD) <li>For add(query, false, true) use
    ...
    void add(Query* query, const bool deleteQuery, const bool required,
