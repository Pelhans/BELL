...
public:
     ...
     * @param ret this array of Explanations should be getDetailsLength()+1 in
     * size. The array will be null terminated.
     */
    void getDetails(Explanation** ret);
    size_t getDetailsLength() const;

    /** Watch out: no NULL reference check is made! Make sure i exists by not
    calling this function without calling getDetailsLength() first!
    */
...
public:
    ...
    ComplexExplanation(const bool _match, const float_t _value,
