...
typedef std::set<CL_NS(index)::Term*, CL_NS(index)::Term_UnorderedCompare>
    TermSet;
...
public:
     ...
     * However, there are the following limitations: <ul> <li>If the query was
     * created by the parser, the printed representation may not be exactly what
     * was parsed. For example, characters that need to be escaped will be
     * represented without the required backslash.</li> <li>Some of the more
     * complicated queries (e.g. span queries) don't have a representation that
