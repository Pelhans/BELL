...
public:
    ...
    public:
        ...
        virtual ~PositionInfo() { _CLLDELETE(positions); }

        void addPosition(int32_t start, int32_t end) {
            positions->push_back(_CLNEW StartEnd(start, end));
        }

        int32_t getDoc() { return doc; }

        /**
         * @return A List of {@link
         * org.apache.lucene.search.SpanFilterResult.StartEnd} objects
         */
        CL_NS(util)::CLList<StartEnd*>* getPositions() { return positions; }
    };
...
public:
     ...
     * @param positions A List of {@link
     * org.apache.lucene.search.SpanFilterResult.PositionInfo} objects
     */
    SpanFilterResult(CL_NS(util)::BitSet* _bits,
                     CL_NS(util)::CLList<PositionInfo*>* _positions)
        : bits(_bits),
     ...
     */
    CL_NS(util)::CLList<PositionInfo*>* getPositions() { return positions; }

    CL_NS(util)::BitSet* getBits() { return bits; }
};
