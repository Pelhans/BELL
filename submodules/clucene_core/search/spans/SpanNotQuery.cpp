...
public:
    SpanNotQuerySpans(SpanNotQuery *parentQuery,
...
SpanNotQuery::SpanNotQuerySpans::SpanNotQuerySpans(
    SpanNotQuery *parentQuery, CL_NS(index)::IndexReader *reader) {
...
/////////////////////////////////////////////////////////////////////////////
SpanNotQuery::SpanNotQuery(SpanQuery *include, SpanQuery *exclude,
                           bool bDeleteQueries) {
...
SpanNotQuery::SpanNotQuery(const SpanNotQuery &clone) : SpanQuery(clone) {
...
const char *SpanNotQuery::getClassName() { return "SpanNotQuery"; }

const char *SpanNotQuery::getObjectName() const { return getClassName(); }

SpanQuery *SpanNotQuery::getInclude() const { return include; }

SpanQuery *SpanNotQuery::getExclude() const { return exclude; }

const TCHAR *SpanNotQuery::getField() const { return include->getField(); }
...
CL_NS(search)::Query *SpanNotQuery::rewrite(CL_NS(index)::IndexReader *reader) {
    ...
    if (rewrittenExclude != exclude) {
        if (!clone) clone = (SpanNotQuery *)this->clone();
...
bool SpanNotQuery::equals(Query *other) const {
    ...
    return include->equals(that->include) && exclude->equals(that->exclude) &&
