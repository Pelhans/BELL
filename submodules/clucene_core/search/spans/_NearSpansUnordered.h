...
#include "clucene_core/util/PriorityQueue.h"
#include "Spans.h"
...
private:
    ...
    /////////////////////////////////////////////////////////////////////////////
    class CellQueue : public CL_NS(util)::PriorityQueue<
                          SpansCell*, CL_NS(util)::Deletor::Object<SpansCell>> {
    public:
        CellQueue(int32_t size) {
            initialize(size, false);
        } // All the span cells will be freed in ~NearSpansUnordered() while
          // frein ordered member
        virtual ~CellQueue() {}
