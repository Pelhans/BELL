...
#include "debug/_condition.h"
#include "LuceneThreads.h"
#include "config/repl_tchar.h"
#include "config/repl_wchar.h"
#include "config/repl_wctype.h" //replacements for functions

#define cl_min(a, b) ((a) > (b) ? (b) : (a))
#define cl_min3(a, b, c) \
    ((a) < (b) ? ((a) < (c) ? (a) : (c)) : ((b) < (c) ? (b) : (c)))
#define cl_max(a, b) ((a) > (b) ? (a) : (b))
#define cl_max3(a, b, c) \
    ((a) > (b) ? ((a) > (c) ? (a) : (c)) : ((b) > (c) ? (b) : (c)))
