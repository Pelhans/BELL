 ...
 * See http://www.unicode.org/Public/UNIDATA/UnicodeData.txt
   ...
   data is licensed like this: http://www.unicode.org/copyright.html... not sure
 but looks apache compatible
 */
typedef enum {
    G_UNICODE_CONTROL,
    G_UNICODE_FORMAT,
...
#pragma message( \
    "===== Note: using internal character function for compatibility =====")
#else
...
bool cl_isspace(gunichar c) {
    switch (c) {
        ...
        default: {
            ...
            return (t == G_UNICODE_SPACE_SEPARATOR ||
                    t == G_UNICODE_LINE_SEPARATOR ||
