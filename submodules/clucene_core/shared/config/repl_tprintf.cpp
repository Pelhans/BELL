...
void lucene_vfnwprintf(StringBuffer* buffer, size_t /*count*/,
            ...
            switch (*iter) {
                ...
                default: {
                    ...
                    if (*iter == 'p')
                        ...
                        if (*iter == 'a' || *iter == 'A' || *iter == 'e' ||
                            *iter == 'E' || *iter == 'f' || *iter == 'F' ||
                            *iter == 'g' || *iter == 'G')
                            tmp->appendFloat((float_t)va_arg(valist, double),
                                             8);
...
int lucene_vsnwprintf(wchar_t* strbuf, size_t count, const wchar_t* format,
                      va_list& ap) {
    StringBuffer buffer;
    lucene_vfnwprintf(&buffer, count, format, ap);
