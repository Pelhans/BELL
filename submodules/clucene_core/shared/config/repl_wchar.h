...
CLUCENE_SHARED_EXPORT size_t lucene_utf8towcs(wchar_t*, const char*,
                                              size_t maxslen);
CLUCENE_SHARED_EXPORT size_t lucene_wctoutf8(char* ret, const wchar_t str);
CLUCENE_SHARED_EXPORT size_t lucene_wcstoutf8(char*, const wchar_t*,
                                              size_t maxslen);
#ifdef _ASCII
...
CLUCENE_SHARED_EXPORT size_t lucene_utf8charlen(
    const unsigned char p); //< the number of characters that this first utf8
                            //character will expect

// string function replacements
#if defined(LUCENE_USE_INTERNAL_CHAR_FUNCTIONS) ||                \
    (defined(_UCS2) && !defined(_CL_HAVE_FUNCTION_WCSCASECMP)) || \
    (defined(_ASCII) && !defined(_CL_HAVE_FUNCTION_STRCASECMP))
CLUCENE_SHARED_EXPORT int lucene_tcscasecmp(const TCHAR*, const TCHAR*);
#undef _tcsicmp
#define _tcsicmp lucene_tcscasecmp
#endif
#if defined(LUCENE_USE_INTERNAL_CHAR_FUNCTIONS) ||            \
    (defined(_UCS2) && !defined(_CL_HAVE_FUNCTION_WCSLWR)) || \
    (defined(_ASCII) && !defined(_CL_HAVE_FUNCTION_STRLWR))
...
#if (defined(_ASCII) && !defined(_CL_HAVE_FUNCTION_LLTOA)) || \
    (defined(_UCS2) && !defined(_CL_HAVE_FUNCTION_LLTOW))
CLUCENE_SHARED_EXPORT TCHAR* lucene_i64tot(int64_t value, TCHAR* str,
                                           int radix);
#undef _i64tot
...
#endif
#if (defined(_UCS2) && !defined(_CL_HAVE_FUNCTION_WCSTOLL)) || \
    (defined(_ASCII) && !defined(_CL_HAVE_FUNCTION_STRTOLL))
CLUCENE_SHARED_EXPORT int64_t lucene_tcstoi64(const TCHAR* str, TCHAR** end,
                                              int radix);
#undef _tcstoi64
...
// printf functions
#if (defined(_UCS2) && (!defined(_CL_HAVE_FUNCTION__SNWPRINTF)) || \
     defined(_CL_HAVE_SNWPRINTF_BUG))
#undef _sntprintf
#define _sntprintf lucene_snwprintf
CLUCENE_SHARED_EXPORT int lucene_snwprintf(wchar_t* strbuf, size_t count,
...
#endif
#if defined(_UCS2) && (!defined(_CL_HAVE_FUNCTION__VSNWPRINTF) || \
                       defined(_CL_HAVE_SNWPRINTF_BUG))
#undef _vsntprintf
#define _vsntprintf lucene_vsnwprintf
CLUCENE_SHARED_EXPORT int lucene_vsnwprintf(wchar_t* strbuf, size_t count,
                                            const wchar_t* format, va_list& ap);
#endif

// todo: if _CL_HAVE_SNPRINTF_BUG fails(snprintf overflow),we should use our own
// function. but we don't have it currently, and our functions are dubious
// anyway...
