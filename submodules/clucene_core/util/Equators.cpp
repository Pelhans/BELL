...
Compare::Int32::Int32(int32_t val) { value = val; }
Compare::Int32::Int32() { value = 0; }
const char* Compare::Int32::getClassName() {
    return "Compare::Int32::getClassName";
}
const char* Compare::Int32::getObjectName() const { return getClassName(); }
...
size_t Compare::Int32::operator()(int32_t t) const { return t; }

float_t Compare::Float::getValue() const { return value; }
Compare::Float::Float(float_t val) { value = val; }
const char* Compare::Float::getClassName() {
    return "Compare::Float::getClassName";
}
const char* Compare::Float::getObjectName() const { return getClassName(); }
...
Compare::Char::Char() { s = NULL; }
Compare::Char::Char(const char* str) { this->s = str; }
const char* Compare::Char::getClassName() {
    return "Compare::Char::getClassName";
}
const char* Compare::Char::getObjectName() const { return getClassName(); }
...
#ifdef _UCS2
bool Compare::WChar::operator()(const wchar_t* val1,
...
Compare::WChar::WChar() { s = NULL; }
Compare::WChar::WChar(const wchar_t* str) { this->s = str; }
const char* Compare::WChar::getClassName() {
    return "Compare::WChar::getClassName";
}
const char* Compare::WChar::getObjectName() const { return getClassName(); }
